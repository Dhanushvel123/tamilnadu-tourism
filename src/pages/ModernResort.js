  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
      ...
      <section className="cta-section py-5 text-light text-center">
        <div className="container">
          ...
          <a href="/bookingpage" className="btn btn-light btn-lg rounded-pill mt-3">
            Book Now <svg xmlns="http://www.w3.org/2000/svg" height="24px" style={{verticalAlign:'middle'}} viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M280-80v-100l120-84v-144L80-280v-120l320-224v-176q0-33 23.5-56.5T480-880q33 0 56.5 23.5T560-800v176l320 224v120L560-408v144l120 84v100l-200-60-200 60Z"/></svg>
          </a>
        </div>
      </section>
    </div>
